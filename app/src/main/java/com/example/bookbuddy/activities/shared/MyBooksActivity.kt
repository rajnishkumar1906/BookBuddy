...
import com.example.bookbuddy.databinding.ActivityMyBooksBinding
...
class MyBooksActivity : AppCompatActivity() {
    ...
    private fun updateDisplayedBooks() {
        ...
        if (booksToShow.isEmpty()) {
            ...
            binding.emptyStateText.text = if (currentTab == 0) {
    ...
    private fun updateCounts() {
        binding.borrowedCountText.text = "${currentlyBorrowed.size} Currently Borrowed"
        binding.returnedCountText.text = "${borrowingHistory.size} Returned"
    }
