...
export default function Footer() {
  ...
  return (
    <footer className="bg-white/95 backdrop-blur-sm border-t border-gray-200 mt-10 py-3">
      <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-2">
        ...
        <div className="flex gap-3 text-xs">
          <Link to="/" className="text-gray-500 hover:text-amber-800 transition-colors">
            Privacy
          </Link>
          <Link to="/" className="text-gray-500 hover:text-amber-800 transition-colors">
            Terms
